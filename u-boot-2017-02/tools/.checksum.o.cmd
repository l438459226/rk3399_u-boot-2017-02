cmd_tools/checksum.o := cc -Wp,-MD,tools/.checksum.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer   -include /home/topeet/Desktop/Android7.1/u-boot/include/libfdt_env.h -idirafterinclude -idirafter/home/topeet/Desktop/Android7.1/u-boot/arch/arm/include -I/home/topeet/Desktop/Android7.1/u-boot/lib/libfdt -I/home/topeet/Desktop/Android7.1/u-boot/tools -DCONFIG_SYS_TEXT_BASE=0x00200000 -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/checksum.o tools/checksum.c

source_tools/checksum.o := tools/checksum.c

deps_tools/checksum.o := \
...
tools/checksum.o: $(deps_tools/checksum.o)
