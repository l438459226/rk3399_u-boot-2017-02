...
// GGC heuristics: --param ggc-min-expand=97 --param ggc-min-heapsize=126776
// options passed:  -nostdinc -I include
// -I /home/topeet/Desktop/Android7.1/u-boot/arch/arm/include
// -iprefix /home/topeet/Desktop/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/../lib/gcc/aarch64-linux-android/4.9.x-google/
// -D __KERNEL__ -D __UBOOT__ -D CONFIG_SYS_TEXT_BASE=0x00200000 -D __ARM__
// -D DO_DEPS_ONLY -D KBUILD_STR(s)=#s
// -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
// -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
// -isystem /home/topeet/Desktop/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/../lib/gcc/aarch64-linux-android/4.9.x-google/include
// -include /home/topeet/Desktop/Android7.1/u-boot/include/linux/kconfig.h
// -MD lib/.asm-offsets.s.d lib/asm-offsets.c -mbionic -march=armv8-a
// -mgeneral-regs-only -mstrict-align -mlittle-endian -mabi=lp64
// -auxbase-strip lib/asm-offsets.s -g -Os -Wall -Wstrict-prototypes
// -Wno-format-security -Wno-format-nonliteral -Werror=date-time
// -fno-builtin -ffreestanding -fno-stack-protector -fstack-usage -fno-pic
...
// -momit-leaf-frame-pointer -mstrict-align
...
.ascii "->GENERATED_BD_INFO_SIZE 304 (sizeof(struct bd_info) + 15) & ~15"	//
// 0 "" 2
	.loc 1 28 0
// 28 "lib/asm-offsets.c" 1
	
.ascii "->GD_SIZE 432 sizeof(struct global_data)"	//
// 0 "" 2
	.loc 1 30 0
...
.LFE157:
	...
	.text
.Letext0:
	.file 2 "/home/topeet/Desktop/Android7.1/u-boot/arch/arm/include/asm/types.h"
...
.LASF20:
	.string	"bi_sramstart"
.LASF56:
	.ascii	"GNU C 4.9.x-google 2"
	.string	"0140827 (prerelease) -mbionic -march=armv8-a -mgeneral-regs-only -mstrict-align -mlittle-endian -mabi=lp64 -g -Os -fno-builtin -ffreestanding -fno-stack-protector -fstack-usage -fno-pic -ffunction-sections -fdata-sections -ffixed-r9 -fno-common -ffixed-x18"
.LASF33:
	.string	"bi_dram"
.LASF12:
	.string	"ulong"
...
.LASF21:
	.string	"bi_sramsize"
.LASF58:
	.string	"/home/topeet/Desktop/Android7.1/u-boot"
.LASF30:
	.string	"bi_busfreq"
.LASF50:
