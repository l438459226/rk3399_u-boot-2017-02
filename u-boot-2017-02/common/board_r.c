...
init_fnc_t init_sequence_r[] = {
	 ...
	 * implement this.
	 */
#ifdef CONFIG_CLOCKS	//NG##################
	set_cpu_clk_info, /* Setup clock information */
#endif
	stdio_init_tables,	//初始化设备链表
	initr_serial,		//为空
	initr_announce,		//$$$$$$$$$$$$$$$$$$$$$$$$$$
	...
	arch_early_init_r,	//int arch_early_init_r(void)
#endif
	power_init_board,
#ifndef CONFIG_SYS_NO_FLASH	//NG ###################################
	initr_flash,
#endif
	INIT_FUNC_WATCHDOG_RESET
#if defined(CONFIG_PPC) || defined(CONFIG_X86)//NG ###################################
	...
	initr_spi,
#endif
#if defined(CONFIG_X86) && defined(CONFIG_SPI)//NG ###################################
	init_func_spi,
#endif
#ifdef CONFIG_CMD_NAND//NG ###################################
	initr_nand,
#endif
#ifdef CONFIG_CMD_ONENAND//NG ###################################
	initr_onenand,
#endif
#ifdef CONFIG_GENERIC_MMC//NG ###################################
	initr_mmc,
#endif
#ifdef CONFIG_HAS_DATAFLASH//NG ###################################
	initr_dataflash,
#endif
#ifdef CONFIG_ROCKCHIP
	initr_rk_storage,	//sdmmc  static int initr_rk_storage(void)
#endif
	initr_env,
	INIT_FUNC_WATCHDOG_RESET	//NG
	initr_secondary_cpu,	//空
#ifdef CONFIG_SC3
	initr_sc3_read_eeprom,	//NG
#endif
#ifdef	CONFIG_HERMES
	initr_hermes,	//NG
#endif
#if defined(CONFIG_ID_EEPROM) || defined(CONFIG_SYS_I2C_MAC_OFFSET)
	mac_read_from_eeprom,	//NG
#endif
	INIT_FUNC_WATCHDOG_RESET	//空
#if defined(CONFIG_PCI) && !defined(CONFIG_SYS_EARLY_PCI_INIT)
	/*
